...
const UpdateForm = ({ handleOk = () => {} }) => {
    ...
    const filesArray = post && post.attachments && post.attachments.map(vid =>{
        return vid.files
    })
  ...
  return (
    <div className='w-full'>
      ...
      Title:
      <Input showCount maxLength={400} name='title' style={{height:50}} value={updateData.title} onChange={handleForm} />
      Title Desc:
      <Input showCount maxLength={400} name='titleDesc' style={{height:50}} value={updateData.titleDesc} onChange={handleForm}  />
      Description:
      <TextArea
        name='description'
