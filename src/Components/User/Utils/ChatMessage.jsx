    ...
    <div className="flex flex-col justify-between h-full">
      <div className="flex px-5 h-20 items-center rounded-tr-3xl  justify-between bg-dark-4">
        <div className="flex flex-row items-center gap-5">
          <Avatar
            {...stringAvatar(usrname ? usrname : "user")}
        ...
        <div>
          <button onClick={handleVcall}>
            <img src={video} alt="vcall" className="h-8 w-8" />
          </button>
        </div>
      </div>
      <div
        className="flex-1 p-5 overflow-y-auto max-h-[440px] scrollbar-hide "
      ...
      <div className="flex flex-row gap-3 p-4  w-full ">
        ...
        />
        <Button radius="full" className="h-11" onClick={handleSubmit}>
          send
        </Button>
      </div>
    </div>
